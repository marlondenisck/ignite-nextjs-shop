  ...
  return (
    ...
    <Header />
     ...
     <div 
      ...
      ref={sliderRef}
     >
      <Link href="/product/1" className='bg-gradient-to-b from-green300 to-[#7465d4] rounded-lg cursor-pointer relative overflow-hidden flex items-center justify-center group keen-slider__slide'>
      ...
      <Link href="/product/2" className='bg-gradient-to-b from-green300 to-[#7465d4] rounded-lg cursor-pointer relative overflow-hidden flex items-center justify-center group keen-slider__slide'>
      ...
      <Link href="/product/3" className='bg-gradient-to-b from-green300 to-[#7465d4] rounded-lg cursor-pointer relative overflow-hidden flex items-center justify-center group keen-slider__slide'>
